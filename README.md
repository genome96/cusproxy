...
git clone https://github.com/genome96/cusproxy.git## RequirementsMulti-protocol proxy server with authentication and encryption support.
...
- HTTPS proxy (recommended): configure your client to use `your-server.com:8443` with your chosen username and password.- Root access

- SOCKS5 proxy: use `your-server.com:1080` with your credentials (no built-in encryption; use on trusted networks only).

- HTTP proxy: use `your-server.com:3128` with your credentials.- Open ports: 1080, 3128, 8443, 11080## Requirements**Production-ready proxy server with authentication and encryption**
